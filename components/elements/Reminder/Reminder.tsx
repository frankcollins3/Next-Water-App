  ...
  return (
    <>
      <li className={styles.li} key={index}>
        <button
          disabled={DISABLED[index]}    // i.e. ->         [true, false, false]                        
          ...
          <span>
            <span>
              ...
              { STATUS[index] === '' ?  null : STATUS[index] === "check" ? <img className={styles.reminderImg} src={mouseDroplet}/> : <img className={styles.reminderImg} style={{ transform: transformers }} src={bg}/>}                
