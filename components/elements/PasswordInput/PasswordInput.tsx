...
import {SET_PASSWORD_INPUT, TOGGLE_INPUT_FOCUS, TOGGLE_INPUT_DBL_CLICK} from '../../../redux/actions'
    ...
    const renderPasswordInput = () => {
        return (
          <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
            ...
            //   style={{ position: 'absolute' }} // Adjust the margin as needed
              style={{ marginLeft: passwordShow ? '45px' : '0px', position: 'absolute' }} // Adjust the margin as needed
            />
