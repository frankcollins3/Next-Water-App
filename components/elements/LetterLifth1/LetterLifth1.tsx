...
//   Type 'boolean' is not assignable to type 'string | TrustedHTML'.ts(2322)
 ...
 function LetterLifth1 (props: h1Props) {
  ...
  className="lifewater"
  style={{
    color: LOG_IN_OUT_FLASH_MSG ? 'silver' : '#73defe',
    fontSize: LOG_IN_OUT_FLASH_MSG ? '13px' : '32px',
    fontFamily: LOG_IN_OUT_FLASH_MSG ? 'Poppins' : 'Moon Dance',
    letterSpacing: LOG_IN_OUT_FLASH_MSG ? '0.25em' : '1.175em',
    whiteSpace: 'pre-line', // Preserve line breaks
  }}
>
  {ICON_NOT_INPUT && FLIP_FLOP_ICON
    ? "Water\nYou?"
    : LOG_IN_OUT_FLASH_MSG || 'Water is Life'}
</h1>
