...
const initialState: logInOutGoogleSliceState = {
  ...
  CURRENT_USER: { id: 0, googleId: '', username: '', email: '', age: 0 , token: '', },
  IS_LOGGED_IN: false,
  ALL_USERS: [],
  ALL_USERNAMES: [],
  ALL_EMAILS: [],
...
const logInOutGoogleSlice = createSlice({
    ...
    reducers: {
        // login data
        TOGGLE_IS_LOGGED_IN: (state) => { state.IS_LOGGED_IN = !state.IS_LOGGED_IN },
        ...
        CLEAR_LOGIN_SIGNUP_INPUTS: (state) => {  state.USERNAME_INPUT = "", state.PASSWORD_INPUT = "", state.AGE_INPUT = "", state.EMAIL_INPUT = "", state.EMAIL_OR_USERNAME_LOGIN_INPUT = "", state.PASSWORD_LOGIN_INPUT = "" },
        ...
        // no need for reset CURRENT_USER ß
...
export const { 
    TOGGLE_LOGIN_SIGNUP_BTN, TOGGLE_IS_LOGGED_IN, TOGGLE_INPUT_FOCUS, TOGGLE_LOGIN_INPUT_FOCUS, TOGGLE_SHOW_FORM, SET_LOGIN_MSG, TOGGLE_LET_USER_REMEMBER_ME, SET_IS_LOGGED_IN_USER, 
    SET_USERNAME_INPUT, SET_PASSWORD_INPUT, SET_EMAIL_INPUT, SET_AGE_INPUT, SET_EMAIL_OR_USERNAME_LOGIN_INPUT, SET_PASSWORD_LOGIN_INPUT, CLEAR_LOGIN_SIGNUP_INPUTS,
