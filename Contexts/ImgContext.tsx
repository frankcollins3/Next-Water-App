...
const computer:string = `${imagePrefix}computer`
const fileUpload:string = `${imagePrefix}fileUpload`

// type the state which will be read-only 'string'
type imgContextType = {
    towelBoy: string;
    towelBlueWhite: string;
    testTube: string;
    fileUpload: string;
    computer: string;
    speechBubble: string;
...
const imgDefaults: imgContextType = {
    ...
    towelBoy: `${imagePrefix}towelBoy.png`,
    towelBlueWhite: `${imagePrefix}towel.png`,
    testTube: `${imagePrefix}test-tube.png`,
    // for image context as well could also organize by feature but certain images like "waterDrop.png" agnostic to feature, present throughout
    fileUpload: fileUpload,
    computer: computer,
    speechBubble: `${imagePrefix}bottle.png}`,
    ...
    waterDrop: `${imagePrefix}water-drop.png`,
...
export function ImgProvider({ children }: Props) {
    ...
    const [towelBlueWhite, setTowelBlueWhite] = useState<string>(`${imagePrefix}towel.png`)
    ...
    const [waterDrop, setWaterDrop] = useState<string>(`${imagePrefix}water-drop.png`);
